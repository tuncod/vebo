...
<template>
  ...
  <div class="font-body w-full min-h-screen bg-white dark:bg-[#111] select-none">
    ...
    <div class="flex justify-between items-center w-full h-16 fixed bottom-0 left-0 right-0 bg-white/40 backdrop-filter backdrop-blur-lg border-t border-zinc-200/40 z-20 lg:hidden">
      <NuxtLink v-for="item in navbar" :to"item.path" class="">
