    ...
    <nav :class="['sidebar', { open: sidebarOpen }]" role="navigation" aria-label="Main navigation">
      ...
      <ul class="nav-links" role="list">
        <li v-for="link in navLinks" :key="link.route">
          <a class="nav-link" :class="{ active: route.path == link.route }" :aria-label="link.label" :href="link.route">
            <svg v-html="link.icon" aria-hidden="true" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"></svg>
