...
<template>
  <NuxtLink class="card relative w-[130px] h-auto shrink-0 hover:scale-90 active:scale-95 transition" :to="props.link">
    <div class="relative aspect-[2/3] overflow-hidden rounded-xl shadow-lg bg-slate-100 dark:bg-zinc-800">
